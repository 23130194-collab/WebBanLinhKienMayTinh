...
<header class="header">
    <div class="header-container">
        ...
        <div class="header-actions">
            <a href="cart.jsp" class="icon-btn" title="Giỏ hàng"><i class="fas fa-shopping-cart"></i></a>
            <a href="user.jsp" class="icon-btn" title="Tài khoản của bạn"><i class="fas fa-user"></i></a>
        </div>
        ...
        <div class="profile">
            <div class="summary-card">
                ...
                <div class="summary-item">
                    <div class="summary-icon"><i class="fa-solid fa-cart-shopping" style="color:#ff0000;"></i></div>
        ...
        <section class="content">
            ...
            <div class="section active" id="order-details">
                <div class="order-details-view">
                    <a class="back-link" href="user.jsp">
                    ...
                    <div class="card detail-card">
                        ...
                        <div class="overview-header">
                            <span>Đơn hàng: <strong>#1988010</strong></span>
                            <span class="divider"></span>
                            <span>Ngày đặt hàng: <strong>29/10/2025</strong></span>
                            <span class="divider"></span>
                    ...
                    <div class="card detail-card">
                        ...
                        <div class="payment-group">
                            ...
                            <div class="payment-line-new"><span>Số lượng sản phẩm:</span><strong>1</strong></div>
                            <div class="payment-line-new"><span>Tổng tiền hàng:</span><strong>3.190.000₫</strong></div>
                            <div class="payment-line-new"><span>Giảm giá:</span><strong
                                    style="color:var(--accent-dark);">-400.000₫</strong></div>
                            <div class="payment-line-new"><span>Phí vận chuyển:</span><strong style="color:green;">Miễn
                                phí</strong></div>
                        </div>

                        <div class="payment-group">
                            <div class="payment-sub-title">Thanh toán</div>
                            <div class="payment-line-new final"><span>Tổng số tiền:</span><strong class="final-price">2.990.000₫</strong>
                            </div>
                            <div class="payment-line-new final"><span>Tổng số tiền đã thanh toán:</span><strong
                                    class="final-price">2.990.000₫</strong></div>
                        </div>
